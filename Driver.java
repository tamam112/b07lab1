...
public class Driver {
    public static void main(String [] args) {
        ...
        //create Polynomial 1
        double [] c1 = {1,2,3};//{6,0,0,5};//{};//{1,2,3};
        int [] e1 = {3,2,0};//{0,1,2,3};//{};//{2,1,0};
        ...
        //create Polynomial 2
        double [] c2 = {1,2,3};//{0,-2,0,0,-9};//{0,4,5};//{0};
        int [] e2 = {2,1,0};//{0,1,2,3,4};//{2,1,0};//{0};
        ...
        System.out.println("p1*p2 evaluated: " + prodP1P2.evaluate(2));
